...
public class WebUtils {
    ...
    public static void allowCrossDomian(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (isCrossDomainFlightRequest(request)) {
            ...
            allowHeaders = toDelimitedString(headerNames, ",");
        }
    ...
    public static void redirectIfPresentReturnUrl(HttpServletRequest request, HttpServletResponse response) throws IOException {
     ...
     * @return 拼接后的字符串
     */
    private static String toDelimitedString(List<String> list, String delimiter) {
